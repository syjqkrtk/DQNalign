...
with tf.Session() as sess:
    ...
    #for X in [10,20,30,50,100,200,300,500]:
    for X in range(10,510,10):
        ...
        for i in range(len(path)):
            ...
            file.write("total time : "+str(now-past)+"\n")
            file.write("---------------------------"+"\n")
        ...
        if FLAGS.print_align:
            ...
            file2.write("DQNalign Project v2.0\n")
            file2.write("Local alignment algorithm (REMINER II) with deep reinforcement learning based heuristic alignment agent (DQNalign)\n")
            file2.write("Sequence 1 : Ecoli_31, length : "+str(len(seq1))+"\n")
            file2.write("Sequence 2 : Ecoli_42, length : "+str(len(seq2))+"\n")
            file2.write("\n")
