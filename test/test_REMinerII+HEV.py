    ...
    for _ in range(47):
        ...
        for __ in range(_+1,47):
            ...
            if FLAGS.print_align:
                ...
                dirname = "./align/REMiner2/%d_%d" % (train_env.win_size, train_env.maxI)
                ...
                file2.write("Sequence 1 : HEV_"+str(_)+", length : "+str(len(seq1))+"\n")
                file2.write("Sequence 2 : HEV_"+str(__)+", length : "+str(len(seq2))+"\n")
                file2.write("\n")
