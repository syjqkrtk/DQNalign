...
tf.app.flags.DEFINE_string('model_name', "DQN", """Name of the model (DQN or SSD)""")
tf.app.flags.DEFINE_string('network_set',"standard", """Network strategy setting (standard or SSD)""")
tf.app.flags.DEFINE_string('strategy',"test_pair", """Test strategy setting""")
tf.app.flags.DEFINE_boolean('resume', False, """Resume training from latest checkpoint""")
tf.app.flags.DEFINE_boolean('show_training', True, """Show windows with workers training""")
